...
public class Main {
    ...
    static {
        ...
        solvers.put("greedy_spt", new GreedySolver("spt"));
        solvers.put("greedy_lrpt", new GreedySolver("lrpt"));
        solvers.put("greedy_est_spt", new GreedySolver("est_spt"));
        solvers.put("greedy_est_lrpt", new GreedySolver("est_lrpt"));
